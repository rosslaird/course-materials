...
- Assessment and Evaluation
  collapsed:: true
	- The principles and methods used in this class are grounded in a large body of research that explores the elements of an [[evidence-based learning environment]]. Those elements include self-direction, internal motivation, ly-motivated, meaningful learning experiences. The results of that research clearly indicate that an effective learning environment should have the following elements:
